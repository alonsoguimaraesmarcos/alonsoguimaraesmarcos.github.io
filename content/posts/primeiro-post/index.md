...
O motor de otimização (OR-Tools) recuperou R$ 39 mil contra R$ 26 mil de uma heurística mais simples testada como comparação - cerca de 53% a mais. Já na escolha dos pontos de partida das rotas, troquei a amostragem aleatória por DBSCAN: em vez de sortear candidatados ou elevar muito o número de candidatos sorteados (mais processamento e tempo), ele varre a base inteira em busca de todo ponto que atende a regra de densidade. O ganho nesse caso foi menor: cerca de 1,1% acima que a técnica aleatória, mas por ter trabalhado com dados concentrados e base pequena. Esse resultado tem potencial em uma base maior e mais dispersa, mais próximo da realidade de serviços.
